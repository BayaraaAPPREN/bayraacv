                     ...
                     <div className='grid md:grid-col justify-center items-center m-2'>
                       <div className='relative inline-block'>
                         <Link href="/https://www.facebook.com/">
                             <img className='inline-block cursor-pointer hover:animate-bounce' src="https://img.icons8.com/ios-glyphs/30/ffffff/facebook.png"/>
                             </Link>
                             <img className='inline-block cursor-pointer hover:animate-bounce' src="https://img.icons8.com/ios-glyphs/30/ffffff/twitter--v1.png"/>
                             <img className='inline-block cursor-pointer hover:animate-bounce' src="https://img.icons8.com/ios-glyphs/30/ffffff/instagram-new.png"/>
                       </div>
                  </div>
              </div>
              <div className=' grid md:grid-col justify-start items-center m-2'>
                  <div className='relative inline-block m-2'>
                      <img className='ml-5 inline-block cursor-pointer hover:animate-bounce' src="/calendar.png"/>
                      <h1 className='mx-4 inline-block text-gray-300 text-xl'>March 10, 2001</h1>
                  </div>
                  <div className='relative inline-block m-2'>
                      <img className='ml-4 inline-block cursor-pointer hover:animate-bounce' src="/google-maps.png"/> 
                      <h1 className='mx-4 inline-block text-gray-300 text-xl'>Mongolia, Ulaanbaatar</h1>
                  </div>
                  <div className='relative inline-block m-2'>
                      <img className='ml-4 inline-block cursor-pointer hover:animate-bounce' src="/email.png"/>
                      <h1 className='mx-4 inline-block text-gray-300 text-xl'>bayarsuren0310@gmail.com</h1>
                  </div>
                  <div className='relative inline-block m-2'>
                      <img className='ml-4 inline-block cursor-pointer hover:animate-bounce' src="/telephone.png"/>
                      <h1 className='mx-4 inline-block text-gray-300 text-xl'>80666605</h1>
                  </div>
                  <div className='relative inline-block m-2'>
                      <img className='ml-4 inline-block cursor-pointer hover:animate-bounce' src="/github.png"/> 
                      <h1 className='mx-4 inline-block text-gray-300 text-xl'>Bayraa_Appren</h1>
                  </div>
              </div>
              <div className='grid md:grid-col justify-center items-center m-2'>
                <button className='border-2 border-white px-20 py-3 m-5 relative inline-block text-white text-l rounded-2xl bg-blue-600 shadow-lg hover:animate-pulse shadow-blue-300'><img className='inline-block mr-2' src="https://img.icons8.com/material-rounded/24/ffffff/download--v1.png"/>Download CV</button>
              </div>
            </div>
                 ...
                 <div className='grid grid-col justify-center items-center '>
                  <div className='relative inline-block'>
                    <div className=' inline-block'>
                      <div className='bg-slate-800 p-10 m-5 rounded-lg hover:animate-bounce cursor-pointer w-96'>
                         <div className='inline-block mr-5'>
                           <img className='' src='/television.png'/>
                         </div>
                    ...
                    <div className=' inline-block'>
                      <div className='bg-slate-800 p-10 m-5 rounded-lg hover:animate-bounce cursor-pointer  w-96'>
                         <div className='inline-block mr-5'>
                           <img className='' src='/smartphone.png'/>
                         </div>
                         <div className='inline-block items-start'>
